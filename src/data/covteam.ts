...
export const retiredMembers = [
  ...
  { name: 'Joker', role: 'PWN', image: '/img/joker.jpg', link: 'https://www.j0k3r.xyz', bio: '2020 级。' },
  {
    name: 'cri1stur',
    role: 'WEB',
    image: '/img/cri1stur.jpg',
  ...
  },
  {
    name: '伤心的小尾巴',
    role: 'WEB',
    image: '/img/sxdxwb.jpg',
    link: 'https://blog.csdn.net/qq_59950255?type=blog',
    bio: '2020 级。走自己的路。',
  },
  { name: 'bluetuu', role: 'PWN', image: '/img/hy.jpg', link: 'http://bluetuu.com/', bio: '2020 级。' },
  { name: 'kaikaix', role: 'WEB', image: '/img/gggvggsd.jpg', link: 'https://kaikaix.github.io', bio: '2021 级。' },
  { name: 'zr', role: 'WEB', image: '/img/zr.jpg', bio: '2020 级。' },
  { name: '于归', role: 'MISC', image: '/img/yugui.jpg', bio: '2020 级。' },
  {
    name: 'Joe1sn',
    role: 'RE',
    image: '/img/joe1sn.jpg',
  ...
  { name: 'thestar', role: 'MISC', image: '/img/thestar.jpg', bio: '2019 级，misc/web 选手，喜欢纸片人。' },
  {
    name: 'cxxxx',
    role: 'CRYPTO',
    image: '/img/cxxxx.jpg',
  ...
  { name: '121212', role: 'RE', image: '/img/default-ava.jpg', bio: '方向逆向。' },
];